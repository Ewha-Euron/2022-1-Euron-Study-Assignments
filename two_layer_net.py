...
Original file is located at
    https://colab.research.google.com/drive/1ksbENxpjxe54z2uym8AH7_GKRUckwksU
"""
...
$\color{blue}{\textit Your Explanation:}$ 1: 큰 데이터 셋은 과적합을 방지하는데 도움이 된다. 3: regularization 강도를 높이면 모델 outlier 특징에 대한 의존성을 줄이고 가중치를 분산시키는 경향이 있어 복잡성이 감소된다. 
