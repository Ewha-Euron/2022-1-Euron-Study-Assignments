...
Original file is located at
    https://colab.research.google.com/drive/14Rpx20N7S4kmncBzIJx2O-BhvOQSFrfq
"""
...
$\color{blue}{\textit Your Explanation:}$ 1-> overfitting 방지 3-> weight가 크게 되는것을 방지하여 model의 generization ability를 증가시킴
