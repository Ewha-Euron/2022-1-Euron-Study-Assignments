...
Original file is located at
    https://colab.research.google.com/drive/1RXZTbPOEZne12nRXBVZKWRZYn2qaDx8B
"""
...
## Answer:
We can see that there is a range in which the weights allows the net to learn and that the range extends when using batch normalization. This is one of the benefits of this layer, that allows a less strict initialization, achieving good results in a bigger range of weights.

We can also see how BN networks perform better in all configurations. This is because the neurons don't need to deal with the internal covariate shift, learning a new distribution of weights in each iteration.
...
## Answer:
If the dimension of features is small the values of m  and  σ  will be noisy and will not represent well the data.
