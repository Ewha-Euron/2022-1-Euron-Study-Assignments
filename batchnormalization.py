...
Original file is located at
    https://colab.research.google.com/drive/1fLTcntbUwtKJ4eFcHvSxTuqeLA_xUqtQ
"""
...
"""# Batch Normalization
배치 정규화 내용은 다음 블로그를 참고 https://gaussian37.github.io/dl-concept-batchnorm/

- 배치 정규화는 학습 과정에서 다양한 분포를 가지는 각 배치 단위 별 데이터를 평균과 분산을 이용해서 정규화하는 것을 말한다.
- 정규화를 통해 분포를 zero mean gaussian 형태로 만든다.
