...
Original file is located at
    https://colab.research.google.com/drive/1E0qo3PCkpL5yY6s1tnnduwCOOLzlhRKl
"""
...
Advantage: There are only 26 characters in English, so the word embed step can be removed and it will use less memory and need less calculation.

Disadvantage: It's harder to learn the relationship between English caracters than to learn Words.
