...
Original file is located at
    https://colab.research.google.com/drive/11XI2-iRGKKggEU1wBfBh6QlMbLyKLIUo
"""
...
## Answer: 
The momentum of AdaGrad will not diminish over time. When the momentum accumulates larger and larger, the update step will become smaller and smaller, so a decay factor is required. And Adam will not have this problem.
...
range_weight_scale = [1e-2, 1.5e-2, 5e-3]
range_lr = [1e-5, 6e-4, 1e-5]
